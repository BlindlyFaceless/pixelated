...
public class ProcedualRecoilandADS : MonoBehaviour
{
    ...
    void Update()
    {
        if (Input.GetButtonDown("Fire1") && weaponSwitching.selectedWeapon == 1)
            Fire();
        else if (Input.GetButton("Fire1") && weaponSwitching.selectedWeapon == 0)
            Fire();
